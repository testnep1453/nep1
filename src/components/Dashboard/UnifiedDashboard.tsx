      ...
      <aside className="hidden md:flex w-64 bg-[#0A1128] border-r border-[#39FF14]/20 z-10 flex-col h-[100dvh] sticky top-0">
        ...
        <div className="p-4 border-b border-[#6358cc]/20">
          <button onClick={() => setDrawerOpen(true)} className={`flex items-center gap-3 w-full p-3 rounded-md transition-all ${isAdmin ? 'bg-[#39FF14]/10 text-[#39FF14] border border-[#39FF14]/30' : 'bg-[#6358cc]/20 text-[#00F0FF] border border-[#00F0FF]/50 shadow-[0_0_20px_rgba(0,240,255,0.3)] animate-pulse-glow'}`}>
            <Icons.Target /> <span className="font-bold tracking-[0.2em] text-sm">{isAdmin ? '⚡ DERS YÖNETİMİ' : '🚀 GÖREVE BAŞLA'}</span>
          </button>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          {activeTab === 'genel' && (
            <div className="space-y-6 sm:space-y-8 animate-fade-in">
              {isAdmin && (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-6 mb-3 sm:mb-8">
                  <div className="clip-path-diagonal bg-[#0A1128]/80 border border-[#39FF14]/30 p-3 sm:p-6 relative group overflow-hidden">
                    ...
                    <p className="text-2xl sm:text-4xl lg:text-5xl font-bold text-[#39FF14] drop-shadow-[0_0_15px_rgba(57,255,20,0.5)]">
              ...
              {isAdmin && (
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-6 mb-4 sm:mb-6">
                  <button
                    onClick={async () => {
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 sm:w-14 sm:h-14 bg-[#F5D32E]/10 rounded-xl flex items-center justify-center border border-[#F5D32E]/30 group-hover:bg-[#F5D32E] group-hover:text-black transition-colors shrink-0">
                        <Play fill="currentColor" />
                      </div>
                      <div className="text-left min-w-0">
                        <span className="block text-[#F5D32E] font-black text-xs sm:text-lg tracking-widest uppercase mb-0.5 sm:mb-1">FRAGMANI BAŞLAT</span>
                        <span className="block text-gray-500 text-[10px] sm:text-xs font-mono uppercase">Tüm ekranları kilitle ve videoyu oynat</span>
                      </div>
                    </div>
                  </button>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 sm:w-14 sm:h-14 bg-[#39FF14]/10 rounded-xl flex items-center justify-center border border-[#39FF14]/30 group-hover:bg-[#39FF14] group-hover:text-black transition-colors text-[#39FF14] shrink-0">
                        <Rocket />
                      </div>
                      <div className="text-left min-w-0">
                        <span className="block text-[#39FF14] font-black text-xs sm:text-lg tracking-widest uppercase mb-0.5 sm:mb-1">HERKESİ DERSE AL</span>
                        <span className="block text-gray-500 text-[10px] sm:text-xs font-mono uppercase">Anlık yönlendirme: Operasyon Odası</span>
                      </div>
                    </div>
                  </button>
                  ...
                  >
                    <div className="flex items-center gap-3 text-red-900 group-hover:text-red-500 transition-colors">
                      <div className="w-8 h-8 sm:w-14 sm:h-14 bg-red-950/20 rounded-xl flex items-center justify-center border border-red-900/30 group-hover:border-red-500/50 shrink-0">
                        <Icons.Logout />
                      </div>
                      <div className="text-left min-w-0">
                        <span className="block font-black text-xs sm:text-lg tracking-widest uppercase mb-0.5 sm:mb-1">KOMUTLARI SIFIRLA</span>
                        <span className="block text-gray-500 text-[10px] sm:text-xs font-mono uppercase">Tüm kilitleri kaldır ve normale dön</span>
                      </div>
                    </div>
                  </button>
                </div>
